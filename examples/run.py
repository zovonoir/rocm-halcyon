...
ops = rh.parse_torch_profiler("/home/zov/rocm-halcyon/torchprofiler/qwen-fp8-disable-graph/fp8-fast-disable-graph.json",device_type="amd")
...
rh.export_to_excel(ops,
    ...
    file_name="ddd.xlsx",sheet_name="fp16")
